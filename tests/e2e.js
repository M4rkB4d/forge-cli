...
function assertNoAiTrace(dir) {
  const patterns = ['Co-authored-by', 'Claude', 'Anthropic', 'ChatGPT', 'generated by', 'auto-generated'];
  const filesToCheck = ['package.json', 'pom.xml', 'README.md'].filter(f => existsSync(join(dir, f)));
